...
<head>
	...
	<title>Cupcake Software - Admin</title>
	<link rel="canonical" href="https://www.wrappixel.com/templates/monster-admin-lite/" />
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>/assets/admin/images/favicon.png">
	<!-- Custom CSS -->
	<link href="<?= base_url() ?>/assets/admin/plugins/chartist/dist/chartist.min.css" rel="stylesheet">
	<!-- Custom CSS -->
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="<?= base_url() ?>/assets/admin/images/users/1.jpg" alt="user" class="profile-pic me-2">Markarn Doe
						</a>
